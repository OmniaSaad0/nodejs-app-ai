  ...
  return (
    <div className="app-container">
      <header className="app-header">
        <div className="learning-objects-logo">LEARNING OBJECTS <span className="book-icon">📖</span></div>
      ...
      <main className="app-main">
        ...
        <div className="upload-actions">
          ...
          />
          <button className="upload-images-button" onClick={() => document.getElementById('imageUpload').click()}>
            📤 UPLOAD IMAGE
          </button>
        </div>
